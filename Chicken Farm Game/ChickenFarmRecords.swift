...
enum ChickenFarmWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: ChickenFarmWebStatus) -> Bool {
        switch (self, other) {
...
extension ChickenFarmWebStatus {
...
extension ChickenFarmWebStatus {
    static func == (lhs: ChickenFarmWebStatus, rhs: ChickenFarmWebStatus) -> Bool {
