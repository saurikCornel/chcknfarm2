...
struct ChickenFarmWebViewBox: UIViewRepresentable {
    // MARK: - Свойства
    
    @ObservedObject var loader: ChickenFarmWebLoader
    
    // MARK: - Координатор
    
    func makeCoordinator() -> ChickenFarmWebCoordinator {
        ChickenFarmWebCoordinator { [weak loader] status in
